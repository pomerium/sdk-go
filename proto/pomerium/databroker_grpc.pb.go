...
func (UnimplementedDataBrokerServiceServer) SetOptions(context.Context, *SetOptionsRequest) (*SetOptionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetOptions not implemented")
}
...
func RegisterDataBrokerServiceServer(s grpc.ServiceRegistrar, srv DataBrokerServiceServer) {
	// If the following call panics, it indicates UnimplementedDataBrokerServiceServer was
...
func (UnimplementedCheckpointServiceServer) SetCheckpoint(context.Context, *SetCheckpointRequest) (*SetCheckpointResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetCheckpoint not implemented")
}
