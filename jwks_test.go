...
func TestEncodeJSONWebKeySetToPEM(t *testing.T) {
	...
	// rsa key generation is not deterministic, so use the key found in:
	// https://cs.opensource.google/go/go/+/refs/tags/go1.17.6:src/crypto/rsa/rsa_test.go;drc=ee3f3a60070ee9edeb3f10fa2e4b90404068cb3a;l=146
	k3 := &rsa.PrivateKey{
